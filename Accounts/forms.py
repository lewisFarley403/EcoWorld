...
This module provides the forms for the user to sign up and update their profile:
    ...
    - `ProfileUpdateForm` : This class extends `ModelForm`.
    Allows user to change their bio and profile picture
usage:
    - SignUpForm: This class provides the form for the user to sign up.
     It should be imported in views.py and used in the signup view.
