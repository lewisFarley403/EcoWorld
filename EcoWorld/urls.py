...
from .views import (merge_opening_page, buy_pack,
                    mergecards,store,pack_opening_page, friends) # Import the view
...
urlpatterns = [
    ...
    # URL for the complete challenge page
    path("completeChallenge/", views.completeChallenge, name='completeChallenge'),
    ...
    #Url for completing a challenge
    path('complete_challenge/', views.completeChallenge, name='complete_challenge'),
    #Url for incrementing the progress tracker
    path("increment_objective/", views.increment_daily_objective, name="increment_objective"),
    #Url for the that pops up after an objective
    path("save_objective_note/", views.save_objective_note, name="save_objective_note"),
]
